...
######################################################################################################
config.event_path = 'data/event_for_online.mat'
...
#pdb.set_trace()
#spio.savemat('Achi1101_bin_time.mat',{'bin_time':bin_time})
...
if prep_mixture:
    ...
    with open('data_online/info.dat',"wb") as f:
...
with open('test_spikes_sleep_bin_online.dat', "wb") as f:
